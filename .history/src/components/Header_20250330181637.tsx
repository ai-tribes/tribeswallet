      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="sr-only">AI Tribes - Tribes Wallet</span>
            <div className="flex items-center">
              <Image src="/images/tribes_logo.png" alt="AI Tribes Logo" width={40} height={40} priority className="mr-3" />
              <div className="flex flex-col">
                <span className="text-xs uppercase tracking-wider text-gray-400">An AI Tribes Product</span>
