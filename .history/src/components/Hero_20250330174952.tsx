        ...
        <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              ...
              >
                <span className="block xl:inline">Each crypto in your wallet</span>{' '}
                <span className="block text-primary-600 xl:inline">is a group chat</span>
              </motion.h1>
              <motion.p 
              ...
              >
                Tribes Wallet reimagines crypto communities by turning each token into its own messaging space. 
                Chat with fellow token holders, send assets seamlessly, and manage your portfolio—all in one secure app.
              </motion.p>
              <motion.div 
