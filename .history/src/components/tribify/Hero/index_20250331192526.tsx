  ...
  return (
    <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <Link href="#build-empire">
            <a className="rounded-md bg-white px-6 py-3 text-lg font-semibold text-black shadow-sm hover:bg-gray-200 transition-colors">
              Get Started
            </a>
          </Link>
          <Link href="#success-stories">
            <a className="rounded-md border border-white px-6 py-3 text-lg font-semibold text-white hover:bg-gray-800 transition-colors">
