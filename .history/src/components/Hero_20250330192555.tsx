        ...
        <div className="relative z-10 pb-8 bg-black sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              ...
              >
                <span className="block xl:inline">Token-Based</span>{' '}
                <span className="block text-gray-400 xl:inline">Messaging Platform</span>
              </motion.h1>
              <motion.p 
              ...
              >
                Tribes Wallet connects token holders directly through messaging. Like Telegram or Signal, but group chats 
                are determined by cryptocurrency ownership. Send messages to tokens and whoever holds them can read and respond.
                Govern your tribe with 51% majority control, just like shareholders in a company.
              </motion.p>
              <motion.div 
