...
export default function Download() {
  return (
    <div className="bg-black min-h-screen">
      <Head>
        <title>Download Tribes Wallet | AI Tribes Ecosystem</title>
        <meta name="description" content="Download Tribes Wallet for iOS, Android, Windows, macOS, or Linux. Start governing your tribes with 51% majority control." />
      </Head>
